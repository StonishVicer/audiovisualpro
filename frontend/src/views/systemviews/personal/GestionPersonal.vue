        ...
        <div class="flex-1 overflow-y-auto p-2">
            <div class="grid gap-4 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
                <div v-if="personal.length === 0"
                    ...
                    <p class="text-sm mb-3 text-center">Crea un nuevo registro de personal para comenzar.</p>
                    <button
                        ...
                        <Icon icon="material-symbols:add" width="22" height="22" class="mr-1" /> Nuevo Personal
                    </button>
                </div>
